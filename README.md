...
This repository is an independent continuation of a school group project.

The original base version of the application was created collaboratively as part of a group assignment. I do not claim sole authorship of that original foundation.

This portfolio repository is a separate copy that I am using to continue the project on my own. From this version onward, all new refactoring, design changes, UX improvements, bug fixes, code cleanup, and added features are my independent work.

## Purpose Of This Repository

This repo exists to show how I can take an existing product idea and improve it further through:
